            ...
            try {
                const completion = await openai.chat.completions.create({
                    ...
                    messages: [
                        ...
                        { role: "system", content: "Give me the score and a detailed report of each skills the candidate have as a product manager for the canpany, rate 1-10" },
                        ...
                        { role: "system", content: `Please analyze the following conversation and provide a detailed report in JSON format with the following structure: 
                    {
                        "short_bio": "string",
                    ...
                    {showDetails && (
                        <div className="expanded-details-section">
                            ...
                            <div className="details-section">
                                ...
                                <p>{analysisResult.elevator_pitch || 'Loading elevator pitch...'}</p>
                                </div>
                            ...
                            <div className="skills-certificates-section">
                                <div className="skills-section">
                                    <h4>Skills</h4>
                                    <ul>
                                    <li>Technical Skills: {analysisResult.skills?.technical_skills || 'Loading...'}</li>
                                    <li>Soft Skills: {analysisResult.skills?.soft_skills || 'Loading...'}</li>
                                    <li>Communication Skills: {analysisResult.skills?.communication_skills || 'Loading...'}</li>
                                </ul>
                                </div>
                            ...
                            <div className="ai-evaluation-section">
                                ...
                                <img src={radarGraph} alt="AI Radar Chart" className="ai-radar-chart"/>
                                <div className="recruiter-notes">
                                    <div className="industry-knowledge-section">
                                        <h4>Industry Knowledge</h4>
                                        <p>{analysisResult.industry_knowledge || 'Loading industry knowledge...'}</p>
                                    </div>

                                    <div className="career-aspiration-section">
                                        <h4>Career Aspiration</h4>
                                        <p>{analysisResult.career_aspiration || 'Loading career aspiration...'}</p>
                                    </div>

                                    <div className="overall-evaluation-section">
                                        <h4>Overall Evaluation</h4>
                                        <p>{analysisResult.overall_evaluation || 'Loading overall evaluation...'}</p>
                                    </div>
                                </div>
                            </div>
